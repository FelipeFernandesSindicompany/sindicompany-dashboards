...
export const EMPRESAS_COM_CONCILIACAO = ['addomus_pdf', 'lirba_pdf', 'habitacional_xlsx', 'datadigitus_pdf', 'gk_pdf', 'manager_adm_pdf', 'consvicta_pdf', 'lfc_xlsx', 'lello_xls', 'alliz_pdf'];
